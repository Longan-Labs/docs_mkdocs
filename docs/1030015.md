...
Then, download the [code for the demo](https://github.com/Longan-Labs/OBD-II-RF-Dev-Kit-Library/blob/master/examples/obd_demo2/obd_demo2.ino), and upload it to Longan Core 01.
