...
Place the light sensor unit under a table lamp.

![](https://raw.githubusercontent.com/Longan-Labs/docs_mkdocs/master/docs/images/1011010/serial-monitor-2.png)

Now gently cover the light sensor on the Light Sensor Card with your finger. This will reduce the amount of light that reaches the sensor to nearly zero.
