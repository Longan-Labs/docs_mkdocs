...
|RX|RX of UART|White|
|5V|VCC, connect to 5V (V1.0/V1.1/V1.2) or 3.3V(V1.3)|Red|
|GND|Ground|Black|

If you got an [Base Shield](https://www.seeedstudio.com/Base-Shield-V2.html) from Seeedstudio, the connection is easy, like below,
