...
4. Download the [bootloader file](https://github.com/Longan-Labs/LONGAN-SAME-TOOLS/raw/master/Longan-same-1.0.3/bootloaders/canbed_m4/bootloader_canbed_atsame51g19a.bin).
